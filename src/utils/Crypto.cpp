/**
 * @file Crypto.cpp
 * @brief Bodies for src/utils/Crypto.hpp — compiled once into app_core. This
 *        is the only utils TU that sees the OpenSSL headers; every contract
 *        is documented on the declarations in the header.
 */
